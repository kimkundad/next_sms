    ...
    <>
      ...
      <div className="d-flex justify-content-between">
        <p className="table_bot_text_p">
          <img className="w-20 mar-ri-10" src="/image/icon_2/check copy.png" />
          ส่งสำเร็จ - ส่งข้อความไปถึงผู้รับเรียบร้อย
        </p>
        <p className="table_bot_text_p">
          <img className="w-20 mar-ri-10" src="/image/icon_2/cancel copy.png" />
          ส่งไม่สำเร็จ - ไม่สามารถส่งข้อความไปถึงผู้รับได้ ( เครือข่ายหรือ ระบบ TBS ขัดข้อง,ผู้ส่งอยุ่ใน Blacklist )
        </p>
        <p className="table_bot_text_p">
          <img className="w-20 mar-ri-10" src="/image/icon_2/loading.png" />
